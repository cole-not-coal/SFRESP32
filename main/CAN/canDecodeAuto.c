...
<<<<<<< HEAD
=======
    *Spare = (uint16_t)((((uint16_t)((stFrame.abData[0] >> 3) & 0x1F)) << 8) | ((uint16_t)(stFrame.abData[1])));
>>>>>>> 9105219 (CAN message decode script)
>>>>>>> 03aad6a (CAN message decode script)
    return ESP_OK;
}
...
<<<<<<< HEAD
=======
    *Spare = (uint8_t)(((stFrame.abData[0] >> 7) & 0x1));
>>>>>>> 9105219 (CAN message decode script)
...
=======
esp_err_t StatusAPPSSensor(CAN_frame_t stFrame, int8_t* rAPPs1, int8_t* rAPPs2, int8_t* rAPPsFinal, uint8_t* Spare, uint8_t* BThrottleOK, uint8_t* BAPPS1Fail, uint8_t* BAPPS2Fail, uint8_t* BAPPSDrift)
>>>>>>> 9105219 (CAN message decode script)
>>>>>>> 03aad6a (CAN message decode script)
{
    /*
...
<<<<<<< HEAD
=======
    *Spare = (uint8_t)(((stFrame.abData[3]) & 0xF));
>>>>>>> 9105219 (CAN message decode script)
...
=======
esp_err_t SetDigOut(CAN_frame_t stFrame, uint8_t* DigitalOutput1, uint8_t* DigitalOutput2, uint8_t* DigitalOutput3, uint8_t* DigitalOutput4, float* RESERVED)
>>>>>>> 9105219 (CAN message decode script)
>>>>>>> 03aad6a (CAN message decode script)
{
    /*
...
<<<<<<< HEAD
=======
    *            RESERVED: The documentation treats this like it doesn't exist
>>>>>>> 9105219 (CAN message decode script)
    * 
>>>>>>> 03aad6a (CAN message decode script)
    *   Returns: ESP_OK if successful, error code if not.
...
=======
    *RESERVED = (float)((((uint32_t)((stFrame.abData[0] >> 4) & 0xF)) << 56) | (((uint32_t)(stFrame.abData[1])) << 48) | (((uint32_t)(stFrame.abData[2])) << 40) | (((uint32_t)(stFrame.abData[3])) << 32) | (((uint32_t)(stFrame.abData[4])) << 24) | (((uint32_t)(stFrame.abData[5])) << 16) | (((uint32_t)(stFrame.abData[6])) << 8) | ((uint32_t)(stFrame.abData[7])));
    return ESP_OK;
}

esp_err_t SetCurrentMaxAC(CAN_frame_t stFrame, float* MaxACCurrentSET, float* RESERVED)
>>>>>>> 9105219 (CAN message decode script)
>>>>>>> 03aad6a (CAN message decode script)
{
    /*
...
<<<<<<< HEAD
=======
    *            RESERVED: Not relevant to the command, fill with FF's or use 2-byte DLC
>>>>>>> 9105219 (CAN message decode script)
    * 
>>>>>>> 03aad6a (CAN message decode script)
    *   Returns: ESP_OK if successful, error code if not.
...
<<<<<<< HEAD
=======
    *RESERVED = (float)((((uint32_t)(stFrame.abData[3])) << 40) | (((uint32_t)(stFrame.abData[4])) << 32) | (((uint32_t)(stFrame.abData[5])) << 24) | (((uint32_t)(stFrame.abData[6])) << 16) | (((uint32_t)(stFrame.abData[7])) << 8) | ((uint32_t)(stFrame.abData[8])));
>>>>>>> 9105219 (CAN message decode script)
>>>>>>> 03aad6a (CAN message decode script)
    return ESP_OK;
}
...
<<<<<<< HEAD
=======
    *RESERVED = (uint8_t)(((stFrame.abData[0] >> 1) & 0x7F));
>>>>>>> 9105219 (CAN message decode script)
>>>>>>> 03aad6a (CAN message decode script)
    return ESP_OK;
}
...
<<<<<<< HEAD
=======
    *            RESERVED: Filled with FF's for future use
>>>>>>> 9105219 (CAN message decode script)
    * 
>>>>>>> 03aad6a (CAN message decode script)
    *   Returns: ESP_OK if successful, error code if not.
...
=======
    *RESERVED = (uint32_t)((((uint32_t)(stFrame.abData[4])) << 24) | (((uint32_t)(stFrame.abData[5])) << 16) | (((uint32_t)(stFrame.abData[6])) << 8) | ((uint32_t)(stFrame.abData[7])));
    return ESP_OK;
}
...
<<<<<<< HEAD
=======
    *RESERVED = (uint32_t)((((uint32_t)(stFrame.abData[5])) << 16) | (((uint32_t)(stFrame.abData[6])) << 8) | ((uint32_t)(stFrame.abData[7])));
>>>>>>> 9105219 (CAN message decode script)
    return ESP_OK;
>>>>>>> 03aad6a (CAN message decode script)
}
...
=======
esp_err_t InverterData5(CAN_frame_t stFrame, int8_t* ThrottleSignal, int8_t* BrakeSignal, uint8_t* DigitalIn1, uint8_t* DigitalIn2, uint8_t* DigitalIn3, uint8_t* DigitalIn4, uint8_t* DigitalOut1, uint8_t* DigitalOut2, uint8_t* DigitalOut3, uint8_t* DigitalOut4, uint8_t* DriveEnable, uint8_t* CapacitorTempLimit, uint8_t* DCCurrentLimit, uint8_t* DriveEnableLimit, uint8_t* IGBTAccelerationLimit, uint8_t* IGBTTemperatureLimit, uint8_t* InputVoltageLimit, uint8_t* TempAccelThrottle, uint8_t* MotorTemperatureLimit, uint8_t* RPMminlimit, uint8_t* RPMMaxlimit, uint8_t* Powerlimit, uint8_t* RESERVED, uint8_t* RESERVED, uint8_t* CANmapversion)
>>>>>>> 9105219 (CAN message decode script)
{
    /*
    *===========================================================================
...
<<<<<<< HEAD
=======
    *RESERVED = (uint8_t)(((stFrame.abData[5] >> 3) & 0x1F));
    *RESERVED = (uint8_t)(((stFrame.abData[6]) & 0x1));
>>>>>>> 9105219 (CAN message decode script)
...
=======
    *            PackInstVoltage: 
    *            PackSOC: State of Charge, How much energy remains in the battery
    *            RelayState: Active State of BMS Outputs and Inputs
    *            Checksum: 
    *            IPack: Pack current
>>>>>>> 9105219 (CAN message decode script)
...
<<<<<<< HEAD
=======
    *PackInstVoltage = (float)((((uint16_t)(stFrame.abData[2])) << 8) | ((uint16_t)(stFrame.abData[3]))) * 0.1f;
    *PackSOC = (uint8_t)((stFrame.abData[4]));
    *RelayState = (uint16_t)((((uint16_t)(stFrame.abData[5])) << 8) | ((uint16_t)(stFrame.abData[6])));
