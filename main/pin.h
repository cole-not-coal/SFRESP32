...
/* Dyno Only */
#define DYNO_PRESSURE_1 ADC_CHANNEL_4 // GPIO4
#define DYNO_PRESSURE_2 ADC_CHANNEL_0 // GPIO0
#define DYNO_PRESSURE_3 ADC_CHANNEL_6 // GPIO6
#define DYNO_TEMP_1 ADC_CHANNEL_0 // GPIO0
#define DYNO_TEMP_2 ADC_CHANNEL_6 // GPIO6
#define DYNO_TEMP_3 ADC_CHANNEL_1 // GPIO1
#define DYNO_FLOW ADC_CHANNEL_2 // GPIO2
