...
#define ADC_PRECHARGE_CAR_SIDE 0
#define ADC_PRECHARGE_ACCU_SIDE 0
#define ADC_MAIN_POS_CAR_SIDE 0
#define ADC_MAIN_NEG_CAR_SIDE 0
#define ADC_MAIN_POS_ACCU_SIDE 0
#define ADC_MAIN_NEG_ACCU_SIDE 0
