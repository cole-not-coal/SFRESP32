...
/* Dyno Only */
#define BOSH_0 ADC_CHANNEL_4 // GPIO0
#define BOSH_1 ADC_CHANNEL_0 // GPIO1
#define BOSH_2 ADC_CHANNEL_6 // GPIO2
#define BOSH_3 ADC_CHANNEL_3 // GPIO3
#define BOSH_4 ADC_CHANNEL_5 // GPIO4
#define BOSH_5 ADC_CHANNEL_1 // GPIO5
#define DYNO_FLOW ADC_CHANNEL_2 // GPIO6
